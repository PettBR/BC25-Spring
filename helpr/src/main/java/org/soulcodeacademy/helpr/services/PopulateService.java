...
public class PopulateService {
    ...
    public void populate() {
        ...
        Cliente cl1 = new Cliente(null, "Cleyton Klient", "cleytin.klient@gmail.com", "21712455886", encoder.encode("batata"), "987654323");
        ...
        ch1.setCliente(cl1);
        Chamado ch2 = new Chamado(null, "Ativação de VPN do sistema", "Conectar aos servidores remotos");
        ch2.setCliente(cl2);
