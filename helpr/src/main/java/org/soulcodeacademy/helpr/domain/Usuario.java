...
public abstract class Usuario { // Abstract → Não será possível criar objetos desta classe
    ...
    @Column(nullable = false)
    protected Perfil perfil; // Indica o que este usuario é no sitema (useamos um ENUM)
