...
public interface CargoRepository extends JpaRepository<Cargo,Integer> { // <Entidade, PK>
    List<Cargo> findByNome(String valor); // equivale ao WHERE nome = valor
...
// Repository = é um recurso que permite manipular a entidade do banco de dados
// Adicionar entidades, atualizar entidades, remover entidades e listar (CRUD)
// Indicar qual a entidade vai ser gerenciado pelo repository e qual o tipo da PK
...
// JpaRepository = possui mais funcionalidades p/ tratar a entidade que o CrudRepository