...
public class TokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        // Passo 4 dos filtros (https://media.discordapp.net/attachments/1019716462212022343/1044621935616733194/unknown.png?width=493&height=450)
    ...
    // Passo 3 dos filtros (https://media.discordapp.net/attachments/1019716462212022343/1044621935616733194/unknown.png?width=493&height=450)
    ...
    // Passo 1 & 2 dos filtros (https://media.discordapp.net/attachments/1019716462212022343/1044621935616733194/unknown.png?width=493&height=450)
    private boolean validarCabecalho(HttpServletRequest request) {
        ...
        // Possuir o Authorization e o valor começar com "Bearer tokenblablabla"
