...
// Esta classe serve de ponte para a comunicação entre a persistência (banco e o framework Spring Security
public class UsuarioSecurity implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        // Indica para o Security as permissões/papéis do meu usuário
